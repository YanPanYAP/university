...
BEGIN
  CRS_CUR.ARCHIVE_BOOKINGS_BY_STATUS(
    p_current_user => 1
  );
...
DECLARE
  v_total NUMBER;
BEGIN
  CRS_ANALYTICS.GET_TOTAL_BOOKINGS(
    p_current_user => 1,
    p_count        => v_total
  );
