...
// MyPlot2Ds.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMyPlot2DsApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMyPlot2DsApp::OnAppAbout)
...
// Создание CMyPlot2DsApp

CMyPlot2DsApp::CMyPlot2DsApp() noexcept
{
	...
	SetAppID(_T("MyPlot2Ds.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMyPlot2DsApp

CMyPlot2DsApp theApp;


// Инициализация CMyPlot2DsApp

BOOL CMyPlot2DsApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMyPlot2DsDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMyPlot2DView));
	if (!pDocTemplate)
		return FALSE;
...
int CMyPlot2DsApp::ExitInstance()
{
...
// Обработчики сообщений CMyPlot2DsApp
