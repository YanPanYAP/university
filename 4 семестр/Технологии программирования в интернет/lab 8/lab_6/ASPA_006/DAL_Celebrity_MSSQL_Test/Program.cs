...
internal class Program
{
    ...
    {
        string CS = "Server=DESKTOP-2R6BPTL; Database = Lab6_Db; TrustServerCertificate=True; Trusted_Connection=true";
        ...
        using (IRepository repo = Repository.Create(CS))
        {
            ...
            }
            {
                ...
                if (c is not null)
                {
                    Console.WriteLine($"OK: {PrintC(c)} "); //GetCelebrityByLifeEventId {id
