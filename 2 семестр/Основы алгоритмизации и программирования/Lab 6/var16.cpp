...
void menu()
{
    ...
    cout << "7. Найти сумму элементов, меньших числа 9\n";
    cout << "0. Выход\n\n";
}
...
int main()
{
    ...
    while (choice != 0)
    {
        ...
        case 6:
            ...
            break;
        case 7:
            cout << "Сумма элементов, меньших числа 9: " << lst.sumLessThan(9) << endl;
            break;
        default:
